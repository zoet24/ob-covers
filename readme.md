...
- Currently the contents of the wish list is only session based - if a user closes their session the contents of the wish list is erased. In future iterations of the site I would like to build a "bag_and_fav_contents" model which would save the contents of the user's bag and wish list from session to session.
